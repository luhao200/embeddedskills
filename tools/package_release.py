...
def build_archives(root: Path, output_directory: Path, version: str) -> list[Path]:
    ...
    archive_name = f"embeddedskills-{version}.zip"
    stale_archives = [
        output_directory / archive_name,
        *output_directory.glob(f"embeddedskills-*-{version}.zip"),
    ]
    ...
    for skill_directory in skill_directories:
        ...
        archive = (
            output_directory / f"embeddedskills-{skill_directory.name}-{version}.zip"
        )
